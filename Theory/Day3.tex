...
{\large Standard deviation ($\hat\sigma$)}
$$\log(P(\hat\sigma|\hat\mu,\mathbf{Y}))\propto \sum^n_{i=1}\log\left(\dfrac{1}{\hat\sigma\sqrt{2\pi}}e^{-\frac{(Y_i-\hat\mu)^2}{2\hat\sigma^2}}\right)\times \log(\tau)(\alpha_0-1)-\beta_0\hat\tau$$
