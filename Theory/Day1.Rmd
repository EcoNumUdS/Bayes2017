...
# Practice 5 - Are you infected? (30 min)
...
- bonus: solve the **division problem**
...
5. Bonus: 1-3 including the distance (see `val3.csv` or `val3.Rds`)
...
$$\frac{X_i - \mu}{\sigma} \leftarrow N(\mu, \sigma)$$


\pause

<!-- Tao pf Central limit theorem matrix spectrum -->

\pause

Poincaré:

> "Tout le mode croit à la loi normale : les physiciens parcequ'ils pensent
