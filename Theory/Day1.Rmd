...
# Finite support set - binomial


# Countably infinite support set - negative binomial
...
# Infinite support set - normal distribution
...
# Infinite support set - lognormal distribution


# Infinite support set - exponential distribution
...
- You organize a party and invite three people
  - regular behavior
  - often late
  - always late
...
![Normal distributon on Wikipedia](Image/normalwiki1.png){width=80%}
