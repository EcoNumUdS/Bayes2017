...
\pause $\rightarrow$ we apply similar probabilistic approach.  
...
- Find the probability the meeting start on time?

\pause

- Find the probability the meeting start is delayed by at least half an hour?
...
Questions regarding $X \cap Y$ \pause "occurence of two species":
...
- bonus: build a function to answer the questions above for any parameters' value.
...
# Practice 6 - Elmer is back (20 min)
...
2. Find the effective rate of success $p$

3. Elmer has 10 bullets, what's the probability he'll have a nice diner?



# Practice 7 - Elmer... the truth (30 min)

- `val1.csv` or `val1.Rds` 1000 different shoots
...
4. We have a new set of data `val2.csv` or `val2.Rds`, what should we do?

4. 1-3 including the distance (see `val3.csv` or `val3.Rds`)
