...
Elmer, the duck hunter, shoots $n$ independent ducks with a success rate of $p$
...
par(mypar)
par(lend=2)
plot(c(-0.5,25.5), c(0,.5), xlab="Values (x)", ylab="Probability", type="n")
points(0:25, dpois(0:25, 1), col=mygreen, type="h", lwd=3)
points(0:25+.18, dpois(0:25, 5), col=mygrey, type="h", lwd=3)
points(0:25-.18, dpois(0:25, 10), col=myblue, type="h", lwd=3)
